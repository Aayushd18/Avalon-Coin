...
if __name__ == '__main__':
    ...
    plaintextNum = int(plaintext)
    # plaintexthex = int(plaintexthex)
    key = 0xC28895BA327B
    permkey = 0x69D2CDB6
    ## FOR 96-BIT
    # plaintext = 0x5A97E895A9837A50CDC2D1E1
    # key = 0x953DDBBFA9BF648FF6940846
    ...
    ciphertext = enc(plaintextNum, key, permkey)
